...
<html>
    ...
    <body>
        ...
        <div id="show-system" class="content scaffold-show" role="main">
            ...
            <f:display bean="system" />
            <g:form resource="${this.system}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.system}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
